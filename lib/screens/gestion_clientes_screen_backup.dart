...
class _GestionClientesScreenState extends GestionScreenState<Cliente> {
  ...
  List<Cliente>? _cachedClientesData;
  List<Cliente>? _cachedClientesArchivadosData;
  Future<List<Cliente>>? _memoizedClientesFuture;
  Future<List<Cliente>>? _memoizedClientesArchivadosFuture;
  ...
  void initState() {
    ...
    _memoizedClientesFuture = appState.clientes;
    _memoizedClientesArchivadosFuture = appState.clientesArchivados;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Future<List<Cliente>> currentFuture = showArchived 
        ? (_memoizedClientesArchivadosFuture ?? appState.clientesArchivados)
        : (_memoizedClientesFuture ?? appState.clientes);
    ...
    return FutureBuilder<List<Cliente>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final cachedData = showArchived ? _cachedClientesArchivadosData : _cachedClientesData;
          if (cachedData != null) {
        ...
        final clientesData = snapshot.data ?? [];
        if (showArchived) {
          _cachedClientesArchivadosData = clientesData;
        } else {
          _cachedClientesData = clientesData;
        }
        
        return _buildScaffoldWithData(context, clientesData);
      },
    );
  }
  
  Widget _buildScaffoldWithData(BuildContext context, List<Cliente> allClientes) {
